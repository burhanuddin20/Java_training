...
public class UserIOConsoleImpl implements UserIO {
    ...
    // method to read the date from user input
    @Override
    public LocalDate readDate(String prompt) {
        ...
        LocalDate enterDate;
        try {
            enterDate=  LocalDate.parse(readString("Enter a date in MM/dd/yyyy format"),formatter);
            return enterDate;
        } catch (DateTimeParseException e) {
          this.print("Date format error: enter as MM/dd/YYYY");
        }
        } 
